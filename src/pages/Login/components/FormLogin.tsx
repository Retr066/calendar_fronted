  ...
  return (
    ...
    >
      ...
      <div className="form-floating mb-3">
        <input type="email" className="form-control" id="floatingInput" placeholder="name@example.com" autoComplete="new-off" />
      ...
      <div className="row gap-3 d-flex justify-content-center">
        <div className="col-6 col-md-5 btn btn-outline-light d-flex justify-content-center align-items-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="1.25em" height="1.25em" viewBox="0 0 184 184" className="me-2" fill="currentColor">
            <path
        ...
        <div className="col-6 col-md-5 btn btn-outline-light d-flex justify-content-center align-items-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="1.25em" height="1.25em" viewBox="0 0 16 16" className="me-2" fill="currentColor">
